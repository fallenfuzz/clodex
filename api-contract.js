...
const API_CONTRACT = [
  ...
  { name: 'onRequestOpenExplorer', kind: 'on', channel: 'request-open-explorer' },
  { name: 'onRequestOpenScm', kind: 'on', channel: 'request-open-scm' },
  { name: 'onRequestOpenWorktrees', kind: 'on', channel: 'request-open-worktrees' },
